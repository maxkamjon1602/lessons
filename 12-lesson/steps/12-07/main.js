...
onTick(() => {
  ...
  // Debug
  label.textContent =
    `onGround:${hero.onGround} | facing:${hero.facingDir} | attacking:${hero.attacking} | camAz:${controls.getAzimuthalAngle().toFixed(2)} | camPol:${controls.getPolarAngle().toFixed(2)}`;
});
